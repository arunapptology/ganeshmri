						...
						<div className="doctor-1">
							...
							<div className="hover-overlay text-center">
								...
								<div className="profile-link">
									<a className="btn btn-sm btn-tra-white black-hover" href="doctor-1.html" title="">View
										More Info</a>
								</div>
							...
							<div className="doctor-meta">
								...
								<p className="p-sm grey-color">Donec vel sapien augue integer turpis cursus porta, mauris
									sed
					...
					<div className="col-md-6 col-lg-3">
						<div className="doctor-1">
							...
							<div className="hover-overlay text-center">
								...
								<div className="profile-link">
									<a className="btn btn-sm btn-tra-white black-hover" href="doctor-2.html" title="">View
										More Info</a>
								</div>
