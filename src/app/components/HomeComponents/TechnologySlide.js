...
const TechnologySlide = () => {
  return (
    <>
    	<section id="video-1" className="bg-lightgrey wide-60 video-section division">
				...
				<div className="row d-flex align-items-center">
					...
					<div className="col-lg-6">
						<div className="txt-block pc-30 mb-40 wow fadeInUp" data-wow-delay="0.4s">
							...
							<h3 className="h3-md steelblue-color">Better Technologies for Better Healthcare</h3>
